...
INSERT INTO `donation_requests` (`id`, `event_name`, `location`, `date`, `time`, `description`, `blood_type_id`, `status`, `created_at`, `updated_at`) VALUES
	(2, 'yoga nakal', 'rumah yoga', '2025-06-28', '21:57:00', 'adsasdadasdasd', 7, 'active', '2025-06-13 10:57:13', '2025-06-13 10:57:13');

CREATE TABLE IF NOT EXISTS `eduction_articles` (
  `id` int NOT NULL AUTO_INCREMENT,
...
INSERT INTO `users` (`id`, `username`, `email`, `password`, `fullname`, `status`, `age`, `phone`, `address`, `blood_type_id`, `birth_date`, `gender`, `donation_history`, `last_donation`, `created_at`, `updated_at`) VALUES
	(12, 'asdadasdasdsad', 'zombiecrafter069@gmail.com', '$2y$10$F/TgqhZVEB0RfBUBAhxv.OzNDuj3qczryXcPkD1HJij01wrFAIHPi', 'edited', 'active', 22, '088217639998', 'dadasda', 2, '2025-06-03', 'male', 'n', NULL, '2025-06-12 19:24:14', '2025-06-12 19:24:14');
