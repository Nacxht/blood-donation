...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
  ...
  (event_name, location, date, time, description, blood_type_id, status)
  VALUES (?, ?, ?, ?, ?, ?, ?)";
  ...
  <div class="flex min-h-screen">
    ...
    <div class="flex-1 p-8">
      <div class="flex justify-between items-center mb-8">
        ...
        <a href="manage_donation.php" class="px-4 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-100 transition duration-200">
      ...
      <div class="bg-white rounded-xl shadow-lg p-6">
        <form id="addDonationForm" action="tambah.php" method="POST">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="md:col-span-2">
              ...
              <textarea id="eventDescription" name="eventDescription" rows="3"
                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent"
                placeholder="Deskripsi acara"></textarea>
            </div>
